          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative animate-slide-up-delay hidden lg:block">
              <div className="relative w-full max-w-lg mx-auto">
                ...
                <img
                  src={heroBao}
                  alt="Delicious Peach Mango Xiao Long Bao with golden filling"
        ...
        <div className="container-main mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {benefits.map((benefit, index) => (
              <div
                key={benefit.title}
                className="bg-card rounded-2xl p-8 shadow-card hover:shadow-elevated transition-all duration-300 hover:-translate-y-1 text-center"
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative">
                ...
                <img
                  src={productBox}
                  alt="Box of Peach Mango Xiao Long Bao - 6 pieces"
                  className="relative w-full max-w-md mx-auto rounded-3xl shadow-elevated"
                />
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                ...
                className="bg-cocoa-light/20 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-cream-light/10"
              >
              ...
              >
                ...
                >
                  ...
                  {openFaq === index ? (
                    ...
                    <ChevronDown className="w-5 h-5 text-cocoa-light flex-shrink-0" />
                  )}
                </button>
                {openFaq === index && (
