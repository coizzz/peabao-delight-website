...
export function Footer() {
  return <footer className="bg-cocoa text-cream-light">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-16 h-16 rounded-full bg-white flex items-center justify-center overflow-hidden border border-cream-light/20">
                <img alt="Peabao Delight Logo" className="w-[90%] h-[90%] object-contain" src="/lovable-uploads/c9867db3-6b97-41a2-8b2e-9fdb7ee109b9.png" />
              </div>
              <span className="text-primary text-2xl" style={{
              fontFamily: "'Luckiest Guy', cursive",
              textShadow: '2px 2px 0 hsl(var(--background) / 0.2)'
            }}>
                Peabao Delight
              </span>
            </div>
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/profile.php?id=61585103797635" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-cream-light/10 flex items-center justify-center hover:bg-primary hover:text-cocoa transition-all duration-300" aria-label="Facebook">
                <Facebook size={20} />
              </a>
              <a href="https://www.instagram.com/peabao_delight/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-cream-light/10 flex items-center justify-center hover:bg-primary hover:text-cocoa transition-all duration-300" aria-label="Instagram">
                <Instagram size={20} />
              </a>
              <a href="#" className="w-10 h-10 rounded-full bg-cream-light/10 flex items-center justify-center hover:bg-primary hover:text-cocoa transition-all duration-300" aria-label="TikTok">
                <Music2 size={20} />
              </a>
            </div>
          </div>
